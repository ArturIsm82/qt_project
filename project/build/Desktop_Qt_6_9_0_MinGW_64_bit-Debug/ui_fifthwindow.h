...
public:
    ...
    void setupUi(QDialog *FifthWindow)
    {
...
#endif
        FifthWindow->setPalette(palette);
        label_5 = new QLabel(FifthWindow);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(280, 20, 951, 31));
        QFont font;
        ...
        img1 = new QLabel(FifthWindow);
        img1->setObjectName("img1");
        img1->setGeometry(QRect(70, 80, 401, 551));
        img1->setPixmap(QPixmap(QString::fromUtf8("img/f626d39268c702ac5e4ea53122ef163bfc853e4c_original.jpeg")));
        img1->setScaledContents(true);
        img2 = new QLabel(FifthWindow);
        img2->setObjectName("img2");
        img2->setGeometry(QRect(470, 80, 401, 551));
        img2->setPixmap(QPixmap(QString::fromUtf8("img/Bthh1yuLlJq7CS1R.jpg")));
        img2->setScaledContents(true);
        img3 = new QLabel(FifthWindow);
        img3->setObjectName("img3");
        img3->setGeometry(QRect(870, 80, 401, 551));
        img3->setPixmap(QPixmap(QString::fromUtf8("img/10360900517938.jpg")));
