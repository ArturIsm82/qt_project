...
public:
    ...
    void setupUi(QDialog *ThirdWindow)
    {
...
#endif
        ThirdWindow->setPalette(palette);
        label_5 = new QLabel(ThirdWindow);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(130, 10, 951, 31));
        QFont font;
        ...
        img1 = new QLabel(ThirdWindow);
        img1->setObjectName("img1");
        img1->setGeometry(QRect(90, 70, 401, 555));
        img1->setPixmap(QPixmap(QString::fromUtf8("img/shapki11-15.png")));
        img1->setScaledContents(true);
        img2 = new QLabel(ThirdWindow);
        img2->setObjectName("img2");
        img2->setGeometry(QRect(490, 70, 401, 555));
