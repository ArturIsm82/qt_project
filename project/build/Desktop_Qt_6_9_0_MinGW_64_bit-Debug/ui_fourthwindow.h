...
public:
    ...
    void setupUi(QDialog *FourthWindow)
    {
...
#endif
        FourthWindow->setPalette(palette);
        label_5 = new QLabel(FourthWindow);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(170, 10, 951, 31));
        QFont font;
        ...
        img1 = new QLabel(FourthWindow);
        img1->setObjectName("img1");
        img1->setGeometry(QRect(180, 70, 401, 551));
        img1->setPixmap(QPixmap(QString::fromUtf8("img/png-transparent-suit.png")));
        img1->setScaledContents(true);
        img2 = new QLabel(FourthWindow);
        img2->setObjectName("img2");
        img2->setGeometry(QRect(580, 70, 391, 551));
        img2->setPixmap(QPixmap(QString::fromUtf8("img/d1c6919f494af1b4c8db4756c835db0a.jpeg")));
